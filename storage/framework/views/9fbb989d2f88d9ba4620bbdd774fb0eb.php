            ...
            <div class="flex-1 min-w-0">
                 <nav class="flex mb-2" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2">
                        ...
                        <li><span class="text-gray-300">/</span></li>
                        <li><span class="text-sm font-medium text-gray-900" aria-current="page"><?php echo e($quizName); ?></span></li>
                    </ol>
                </nav>
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">
                    Quiz: <?php echo e($quizName); ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $mcqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $mcq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-blue-50/50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-6 text-sm text-gray-800 align-top">
                                <p class="font-medium text-lg mb-2"><?php echo e($mcq->question); ?></p>
...
<?php /**PATH D:\quiz_app\quiz\quiz_system\resources\views/show-quiz.blade.php ENDPATH**/ ?>