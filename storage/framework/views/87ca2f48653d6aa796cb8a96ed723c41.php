        ...
        <div class="w-full max-w-5xl space-y-8">
            ...
            <div class="w-full max-w-3xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 p-8 text-center relative">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-2">
                    <?php echo e($percentage >= 70 ? 'Excellent Job!' : ($percentage >= 40 ? 'Good Effort!' : 'Keep Practicing!')); ?>

                </h2>
                
                <p class="text-lg text-gray-600 mb-8">
                    You answered <span class="font-bold text-blue-600"><?php echo e($correctAns); ?></span> out of <span class="font-bold text-gray-800"><?php echo e($total); ?></span> questions correctly.
                </p>

                <!-- Percentage Bar -->
                <div class="w-full max-w-md mx-auto bg-gray-100 rounded-full h-4 mb-8 overflow-hidden">
                    <div class="h-full rounded-full transition-all duration-1000 ease-out <?php echo e($percentage >= 70 ? 'bg-green-500' : ($percentage >= 40 ? 'bg-yellow-500' : 'bg-red-500')); ?>" 
                    ...
                    <div class="p-6 flex flex-col md:flex-row items-start md:items-center gap-4 hover:bg-gray-50 transition-colors">
                        ...
                        <div class="flex-shrink-0">
                            <span class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm
                                <?php echo e($item->is_correct ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'); ?>">
                                <?php echo e($key + 1); ?>
                        ...
                        <div class="flex-grow">
                            <p class="text-gray-800 font-medium text-lg"><?php echo e($item->question); ?></p>
                        </div>
...
<?php /**PATH D:\quiz_app\quiz\quiz_system\resources\views/quiz-result.blade.php ENDPATH**/ ?>