...
<head>
    ...
    <title><?php echo e($quizname); ?> - Start Quiz</title>
    ...
    <div class="flex-grow flex items-center justify-center p-4">
        <div class="w-full max-w-4xl bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row shadow-blue-500/10 border border-gray-100">
            ...
            <div class="md:w-3/5 p-10 flex flex-col justify-center">
                ...
                <div class="space-y-4 mb-10">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm"><?php echo e($quizcount); ?> Questions in this quiz</p>
                        </div>
                    </div>
                ...
                <?php if(session('user')): ?>
                  <a href="/mcq/<?php echo e(session('firstmcq')->id); ?>/<?php echo e(str_replace(' ', '%20', $quizname)); ?>" 
...
<?php /**PATH D:\quiz_app\quiz\quiz_system\resources\views/user-start-quiz.blade.php ENDPATH**/ ?>