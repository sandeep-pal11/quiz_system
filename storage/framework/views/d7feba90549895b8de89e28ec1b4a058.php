        ...
        <div class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 text-center lg:text-left lg:flex lg:items-center lg:justify-between">
            ...
            <div class="lg:w-1/2 mt-16 lg:mt-0 relative">
                <div class="relative w-full max-w-lg mx-auto">
                    ...
                    <img src="<?php echo e(asset('quiz-hero.png')); ?>" 
    ...
    <div class="bg-white border-y border-gray-100">
        <div class="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div class="p-4">
                    <div class="text-4xl font-bold text-blue-600 mb-2"><?php echo e(count($categories)); ?></div>
                    <div class="text-gray-500 font-medium">Categories</div>
                </div>
                <div class="p-4">
                     <div class="text-4xl font-bold text-indigo-600 mb-2"><?php echo e(count($quizdata)); ?></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a href="user-quiz-list/<?php echo e($category->id); ?>/<?php echo e(str_replace('','-',$category->name)); ?>" class="group">
                        <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:-translate-y-1 h-full flex flex-col">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors"><?php echo e($category->name); ?></h3>
                            <p class="text-gray-500 text-sm line-clamp-2 mt-auto">Explore quizzes in <?php echo e($category->name); ?> and test your knowledge.</p>
                        </div>
                    </a>
...
<?php /**PATH D:\quiz_app\quiz\quiz_system\resources\views/welcome.blade.php ENDPATH**/ ?>