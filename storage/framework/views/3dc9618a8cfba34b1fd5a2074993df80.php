...
<head>
  <meta charset="utf-8">
  <title>Category: <?php echo e(str_replace('-','',$category)); ?></title>
  ...
  <div class="flex flex-col min-h-screen items-center py-10 px-4">
    ...
    <div class="flex items-center justify-between w-full max-w-4xl mb-6">
      <h1 class="text-3xl font-extrabold text-blue-800 drop-shadow-lg">
        Category: <?php echo e(str_replace('-','',$category)); ?>
...
<?php /**PATH D:\quiz_app\quiz\resources\views/user-quiz-list.blade.php ENDPATH**/ ?>