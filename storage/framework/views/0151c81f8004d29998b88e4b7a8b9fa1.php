    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-top: 40px;">
        ...
        <div style="padding: 20px; color: #374151; font-size: 16px; line-height: 1.5;">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="<?php echo e($link); ?>" style="background-color: #2563eb; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: bold; display: inline-block;">Reset Password</a>
            </div>
            
            <p style="font-size: 14px; color: #6b7280;">Or copy and paste this link into your browser:<br> <a href="<?php echo e($link); ?>" style="color: #2563eb;"><?php echo e($link); ?></a></p>
        </div>
        
        <div style="text-align: center; margin-top: 20px; padding-top: 20px; border-top: 1px solid #e5e7eb; color: #9ca3af; font-size: 12px;">
            <p>&copy; <?php echo e(date('Y')); ?> Quiz Master. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\quiz_app\quiz\quiz_system\resources\views/mail/user-forgot-password.blade.php ENDPATH**/ ?>