            ...
            <?php if(session('status')): ?>
                <div class="mb-6 bg-green-50 border-l-4 border-green-500 p-4 text-left">
                    <p class="text-sm text-green-700 font-medium">
                        <i class="fa-solid fa-check-circle mr-1"></i> <?php echo e(session('status')); ?>

                    </p>
                </div>
            <?php endif; ?>

            <form action="<?php echo e(url('/user-forgot-password')); ?>" method="POST" class="space-y-5 text-left" novalidate>
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="email" name="email" placeholder="you@example.com"
                            class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-shadow <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100">
                <a href="<?php echo e(url('/user-login')); ?>" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-blue-600 transition-colors">
...
<?php /**PATH D:\quiz_app\quiz\quiz_system\resources\views/user-forgot-password.blade.php ENDPATH**/ ?>