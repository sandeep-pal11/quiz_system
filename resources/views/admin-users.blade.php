    ...
    <main class="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                        ...
                        <tr class="hover:bg-blue-50/50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-3">
                                    @if($user->active > 0)
                                    <a href="{{ url('toggle-user-status/'.$user->id) }}" class="text-orange-500 hover:text-orange-700 bg-orange-50 hover:bg-orange-100 p-2 rounded-lg transition-colors border border-transparent hover:border-orange-200" title="Block User">
                                        <i class="fa-solid fa-ban"></i>
                                    </a>
                                    @else
                                    <a href="{{ url('toggle-user-status/'.$user->id) }}" class="text-green-500 hover:text-green-700 bg-green-50 hover:bg-green-100 p-2 rounded-lg transition-colors border border-transparent hover:border-green-200" title="Unblock User">
                                        <i class="fa-solid fa-check"></i>
                                    </a>
                                    @endif

                                    <button onclick="confirmUserDelete({{ $user->id }})" class="text-red-500 hover:text-red-700 bg-red-50 hover:bg-red-100 p-2 rounded-lg transition-colors border border-transparent hover:border-red-200" title="Delete User">
            ...
            <div class="bg-gray-50 px-4 py-3 border-t border-gray-200 sm:px-6">
                <!-- <div class="text-xs text-center text-gray-500">Showing all {{ count($users) }} users</div> -->
            </div>
        </div>
