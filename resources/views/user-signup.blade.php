    ...
    <div class="flex-grow flex items-center justify-center p-4">
        <div class="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row shadow-indigo-900/10">
            ...
            <div class="md:w-1/2 p-8 md:p-12 bg-white overflow-y-auto max-h-[85vh]"> <!-- Added overflow for smaller screens just in case -->
                ...
                <form action="{{ url('/user-signup') }}" method="POST" class="space-y-5" novalidate>
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" id="name" 
                                value="{{ old('name') }}"
                                class="pl-10 block w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-50 py-3 border @error('name') border-red-300 ring-red-200 @enderror transition-all" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="email" id="email" 
                                value="{{ old('email') }}"
                                class="pl-10 block w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-50 py-3 border @error('email') border-red-300 ring-red-200 @enderror transition-all" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="password" 
                                class="pl-10 block w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-50 py-3 border @error('password') border-red-300 ring-red-200 @enderror transition-all" 
                                placeholder="••••••••">
                        </div>
                        @error('password')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
